...
package com.example.administrator.threeumeng0418.onekeyshare;
...
import com.example.administrator.threeumeng0418.R;
...
public class EditPage extends FakeActivity implements OnClickListener, TextWatcher, Callback {
	...
	private void initPageView() {
		...
		llTitle.setBackgroundResource(R.mipmap.title_back);
		...
		ivPin.setImageResource(R.mipmap.pin);
		...
		ivShadow.setBackgroundResource(R.mipmap.title_shadow);
		ivShadow.setImageResource(R.mipmap.title_shadow);
		...
		if(shareImage){
			...
			btn.setBackgroundResource(R.mipmap.img_cancel);
